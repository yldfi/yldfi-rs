...
//!         .with_from_chain(lifi::chains::ETHEREUM)
//!         .with_to_chain(lifi::chains::ARBITRUM);
//!
//!     loop {
...
//! # Error Handling
//!
//! All API methods return `Result<T, lifi::Error>`:
//!
//! ```no_run
//! use lifi::{Client, QuoteRequest, Error, chains};
//! use lifi::error::DomainError;
//!
