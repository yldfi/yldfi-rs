...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut opts = dsim::activity::ActivityOptions::new();
    opts.limit = Some(5);
    let activity = client
        .activity()
    ...
    let token_opts = dsim::tokens::TokenInfoOptions::new("1");
    ...
    println!("\n=== Recent Transactions ===");
    let mut tx_opts = dsim::transactions::TransactionsOptions::new();
    ...
    println!("\n=== Collectibles (NFTs) ===");
    let mut nft_opts = dsim::collectibles::CollectiblesOptions::new();
